...
// exports.getAllAttendance = async (req, res) => {
//   try {
//     const { employeeId, startDate, endDate, page = 1, perPage = 100 } = req.query;
//     const skip = (parseInt(page) - 1) * parseInt(perPage);
...
//       // Map actual records for this employee
...
//           // already present
//           allRecords.push(recordMap[dateKey]);
//         } else {
//           // missing => Absent by default (you can add rules for Half Day / Leave here)
//           allRecords.push({
...
//     res.status(200).json({
//       status: 'success',
//       message: 'Attendance records fetched (with auto Absent)',
//       currentPage: parseInt(page),
//       perPage: parseInt(perPage),
//       totalPages,
//       totalCount,
...
// };
//-----------------------3----------------
//GET PRESENT,ABSENT,WEEKLYOFF,LEAVE
...
//       // For virtual records, we need to create a new actual attendance record
